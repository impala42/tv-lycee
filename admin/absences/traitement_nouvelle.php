...
if (
    ...
    $stmt = $pdo->prepare("INSERT INTO Absence (date_debut, date_fin, professeur, matiere, champ_libre, id_etablissement) VALUES (:date_debut, :date_fin, :professeur, :matiere, :champ_libre, :id_etablissement)");
